...
Alimenter la classe de test ATMTest avec tous les cas de test unitaire de la classe ATM que vous jugerez utiles. Attention: un bug s'est glissé dans l'implémentation d'ATM. Saurez-vous le débusquer ?